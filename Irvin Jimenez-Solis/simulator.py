#!/bin/python3
# Event simulator for COMP-SCI 5590/490 (Distributed Computing Systems)
...
class Message(object):
    def __init__(self, message_id, src, dest, mtype, payload):
    ...
    def addToProposed(self, num):
        self.proposedSeqNo.append(num)
     
    def __str__(self):
        return '' + str(self.message_id) + '::' + str(self.src) + '=>' + str(self.dest) + '--[' + self.payload +']'
...
class Node:
    ...
    def receive(self, time, frm, message):
        ...
        self.receive_message(time, frm, message)
